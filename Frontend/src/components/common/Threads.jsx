...
const Threads = ({ color = [1, 1, 1], amplitude = 1, distance = 0, enableMouseInteraction = false, ...rest }) => {
  ...
  useEffect(() => {
    ...
    // Ensure canvas fills container edge-to-edge
    ...
    // Respect device pixel ratio for crisp, full-size rendering
  ...
  return <div ref={containerRef} className="fixed inset-0 w-screen h-screen" style={{ position: 'fixed', inset: 0, width: '100vw', height: '100vh' }} {...rest} />;
};
